...
class Timeline {
    ...
    initVis() {
        ...
        // construct an array for negative tweets (each object has the format {key,value,len}, where key is the month,
        // values is the data array, and len is the count of negative tweets)
        let NegData = []
        ...
        let pos_len = vis.PosData.map(a => a.len);
